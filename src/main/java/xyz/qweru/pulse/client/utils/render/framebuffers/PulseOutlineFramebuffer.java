package xyz.qweru.pulse.client.utils.render.framebuffers;
 ...
 * @author x150
 */
public class PulseOutlineFramebuffer extends Framebuffer {
    private static PulseOutlineFramebuffer instance;

    private PulseOutlineFramebuffer(int width, int height) {
        super(false);
    ...
    private static PulseOutlineFramebuffer obtain() {
        if (instance == null) {
            instance = new PulseOutlineFramebuffer(MinecraftClient.getInstance().getFramebuffer().textureWidth,
    ...
    public static void use(Runnable r) {
        ...
        RenderSystem.assertOnRenderThreadOrInit();
        PulseOutlineFramebuffer buffer = obtain();
    ...
    static PulseOutlineFramebuffer buffer;
    /**
     * End partial draw
     */
